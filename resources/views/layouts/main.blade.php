...
<head>
    ...
    <link rel="stylesheet" href="../public/assets/vendors/font-awesome/css/all.min.css">
    <link rel="stylesheet" href="../public/assets/vendors/aos/aos.css">
...
<header class="edica-header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.html"><img src="../public/assets/images/logo.svg" alt="Edica"></a>
    ...
    <div class="container">
        <div class="footer-banner" data-aos="fade-up">
            ...
            <div class="banner-btns-wrapper">
                <button class="btn btn-success"> <img src="../public/assets/images/apple@1x.svg" alt="ios" class="mr-2"> App Store</button>
                <button class="btn btn-success"> <img src="../public/assets/images/android@1x.svg" alt="android" class="mr-2"> Google Play</button>
            </div>
...
<script src="../public/assets/vendors/popper.js/popper.min.js"></script>
